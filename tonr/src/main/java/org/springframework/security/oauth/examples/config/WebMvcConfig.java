...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    @Bean
    public SparklrRedirectController sparklrRedirectController(@Qualifier("sparklrRedirectService") SparklrService sparklrService) {
    ...
    protected static class ResourceConfiguration {
        ...
        public OAuth2RestTemplate sparklrRestTemplate(OAuth2ClientContext clientContext) {
            OAuth2RestTemplate template = new OAuth2RestTemplate(sparklr(), clientContext);
            return template;
        }
