    ...
    public int vote(Authentication authentication, MethodInvocation object,
        ...
        for (ConfigAttribute attr : attributes) {
            if (logger.isDebugEnabled()) {
                logger.debug("Voting ConfigAttribute:" + attributes);
            }
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("Voting domainObject:" + domainObject);
            }
            ...
            try {
                if (logger.isDebugEnabled()) {
                    logger.debug("Voting sids:" + sids);
                    logger.debug("Voting acl:" + acl);
                    logger.debug("Voting requirePermission:" + requirePermission);
                }
